...
class EYEDiscoverController: UIViewController, LoadingPresenter {
    ...
    private func getData() {
        ...
        Alamofire.request(.GET, FJAPIHeapler.API_Discover).responseSwiftyJSON ({ [unowned self](request, response, json, error) -> Void in
    ...
    private lazy var collectionView : UICollectionView = {
        ...
        collectionView.registerClass(EYEDiscoverCell.self, forCellWithReuseIdentifier: EYEChioceCell.reuseIdentifier)
