...
class EYEDiscoverDetailController: EYEBaseViewController, LoadingPresenter {
    ...
    override func viewDidLoad() {
        ...
        // 返回按钮
        self.navigationItem.leftBarButtonItem = UIBarButtonItem.barButtonItemWithImage(UIImage(named: "ic_action_back"), selectorImg: nil, target: self, action: #selector(EYEDiscoverDetailController.leftBtnDidClick))
        // 添加headerView
